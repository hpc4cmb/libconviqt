...
void IO_backend_status()
  {
  cout << "Default I/O backend: " << iohandle_current::Type() << endl;
  }
...
void target_status()
  ...
  cout << "LevelS compilation target: unknown" << endl;
#else
  cout << "LevelS compilation target: " LEVELS_TARGET << endl;
#endif
  }
